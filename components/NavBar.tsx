...
const navigation = [
  ...
  { name: "Pricing", href: "https://gpt.caelumai.io/plan", icon: <PricingIcon /> },
  {
    name: "Github",
    href: "https://github.com/caelumai/CaelumGPT",
    icon: <GithubIcon />,
  },
  { name: "Docs", href: "https://docs.caelumai.io/", icon: <DocsIcon /> },
];
          ...
          <>
            <div className="align-center flex h-16 flex-row justify-between">
              <div className="flex flex-shrink-0 cursor-pointer items-center lg:flex-1">
                <Image
                  src="/logos/dark-default-solid.png"
                  width="25"
                  height="25"
                  alt="Caelum AI"
                  className="mb-1 mr-2 invert-0"
                />
                <span className="text-xl font-light tracking-wider">Caelum</span>
              </div>
