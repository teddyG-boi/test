      ...
      <div className="flex flex-row">
          ...
          <Terminal className="absolute" title="index.ts">
            <pre className="overflow-x-hidden">
              {"" +
                ...
                "<html>\n" +
                "<head>\n" +
                " <title>My TestAgent Website</title>\n" +
                "</head>\n" +
                "<body>\n" +
                "  <h1>Welcome to TestAgent!</h1>\n" +
                "  <p>Explore the power of autonomous AI agents.</p>\n" +
                '  <script src="https://gpt.testagent.io/testagent.js"></script>\n' +
                "  <script>\n" +
                "    // Connect to TestAgent API\n" +
                "    const agent = new TestAgent();\n" +
                "    agent.connect('YOUR_API_KEY');\n" +
                "    \n" +
                "    // Example code to interact with TestAgent\n" +
          ...
          <Terminal className="absolute left-16 top-20 z-10" title="agent_service.py">
            <pre className="overflow-x-hidden">
              {"import requests\n" +
                ...
                'url = "https://api.testagent.example.com"\n' +
                "\n" +
        ...
        <div className="mt-28 w-full">
          ...
          <div className="mt-6 flex flex-row gap-4">
            <a href="https://github.com/testagent" target="_blank">
              <PrimaryButton>View on Github</PrimaryButton>
            </a>
            <a href="https://github.com/orgs/testagent/projects/3" target="_blank">
