---
title: "Workflows"
description: "The workflow automation system within TestAgent."
icon: "wave-sine"
---

A core function of TestAgent is AI powered workflow automation. This documentation covers key concepts within our workflow platform.
...
- open platform/testagent_platform/schemas/workflow/blocks
...
- open platform/testagent_platform/web/api/workflow/blocks/web/__init__.py
    - import your block
