---
title: Memory
description: Understanding how TestAgent manages memory with the help of vector databases.
icon: "brain"
---

# Memory Management in TestAgent
...
1. Weaviate is open-source and conveniently accessible via docker-compose, eliminating the need for an API key for local TestAgent runs.
