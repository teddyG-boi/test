...
const getEnvDefinition = (envValues, isDockerCompose, dbPort, platformUrl) => {
  return {
    ...
    Backend: {
      TESTAGENT_PLATFORM_ENVIRONMENT: "${NODE_ENV}",
      TESTAGENT_PLATFORM_FF_MOCK_MODE_ENABLED: false,
      TESTAGENT_PLATFORM_MAX_LOOPS: "${NEXT_PUBLIC_MAX_LOOPS}",
      TESTAGENT_PLATFORM_OPENAI_API_KEY:
        envValues.openAiApiKey || '""',
      TESTAGENT_PLATFORM_FRONTEND_URL: "http://localhost:3000",
      TESTAGENT_PLATFORM_RELOAD: true,
      TESTAGENT_PLATFORM_OPENAI_API_BASE: "https://api.openai.com/v1",
      TESTAGENT_PLATFORM_SERP_API_KEY: envValues.serpApiKey || '""',
      TESTAGENT_PLATFORM_REPLICATE_API_KEY: envValues.replicateApiKey || '""',
    },
    "Database (Backend)": {
      TESTAGENT_PLATFORM_DATABASE_USER: "testagent_platform",
      TESTAGENT_PLATFORM_DATABASE_PASSWORD: "testagent_platform",
      TESTAGENT_PLATFORM_DATABASE_HOST: "testagent_db",
      TESTAGENT_PLATFORM_DATABASE_PORT: dbPort,
      TESTAGENT_PLATFORM_DATABASE_NAME: "testagent_platform",
      TESTAGENT_PLATFORM_DATABASE_URL:
        "mysql://${TESTAGENT_PLATFORM_DATABASE_USER}:${TESTAGENT_PLATFORM_DATABASE_PASSWORD}@${TESTAGENT_PLATFORM_DATABASE_HOST}:${TESTAGENT_PLATFORM_DATABASE_PORT}/${TESTAGENT_PLATFORM_DATABASE_NAME}",
    },
    "Database (Frontend)": {
      DATABASE_USER: "testagent_platform",
      DATABASE_PASSWORD: "testagent_platform",
      DATABASE_HOST: "testagent_db",
      DATABASE_PORT: dbPort,
      DATABASE_NAME: "testagent_platform",
      DATABASE_URL:
